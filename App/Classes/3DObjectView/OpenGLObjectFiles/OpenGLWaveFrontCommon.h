...
static inline Vector3D Vector3DDivideScalar(Vector3D vector1, float value)
{
    Vector3D v = {  vector1.x / value,
                    vector1.y / value,
                    vector1.z / value };
...
{
    Vector3D v = {  vector1.x - vector2.x,
                    vector1.y - vector2.y,
                    vector1.z - vector2.z };
...
static inline Vector3D Vector3DNormalize2(Vector3D vector)
{
